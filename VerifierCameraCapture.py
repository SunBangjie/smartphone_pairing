...
def main():
    ...
    while True:
        ...
        if (
            ...
            depth_img = capture.depth[Threshold.X_MIN:Threshold.X_MAX,
                                      Threshold.Y_MIN:Threshold.Y_MAX]
            depth_img = cv2.normalize(
                depth_img, None, 0, 255, cv2.NORM_MINMAX, dtype=cv2.CV_8U)

            color_img = capture.transformed_color[Threshold.X_MIN:Threshold.X_MAX,
                                                  Threshold.Y_MIN:Threshold.Y_MAX]
            ...
            colorbuffer.append(color_img)
            depthbuffer.append(depth_img)
