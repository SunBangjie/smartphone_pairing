...
def do_experiment(experiment_name):
    ...
    #ComputeAndVisualizeAcceleration.visualize_verifier(experiment_name, show_X=True, show_Y=True, show_Z=True)
    #ComputeAndVisualizeAcceleration.visualize_sender(experiment_name, show_X=True, show_Y=True, show_Z=True)
